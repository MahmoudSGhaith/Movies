...
class AppTheme {
  static final ThemeData darkTheme = ThemeData(
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
          elevation: 2, showSelectedLabels: false , showUnselectedLabels: false
      ),
      inputDecorationTheme: InputDecorationTheme(
        errorBorder: OutlineInputBorder(
          borderSide: BorderSide(color: ColorsManger.red , width: 2 , strokeAlign: 2),
          borderRadius: BorderRadius.circular(25.r),
        ),
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(color: ColorsManger.yellow , width: 2 , strokeAlign: 2),
          borderRadius: BorderRadius.circular(25.r),
        ),
        enabledBorder: OutlineInputBorder(
          borderSide: BorderSide(color: ColorsManger.white , width: 2 , strokeAlign: 2),
          borderRadius: BorderRadius.circular(25.r),
        ),
